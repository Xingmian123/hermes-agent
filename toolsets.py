...
TOOLSETS = {
    ...
    "hermes-ws_direct": {
        "description": "WebSocket Direct toolset - full gateway access via WebSocket (terminal has safety checks)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
